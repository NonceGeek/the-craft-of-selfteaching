...
请先行阅读 [T-appendix.jupyter-installation-and-setup](T-appendix.jupyter-installation-and-setup.md) 以便在本地安装 [Node.js](https://nodejs.org/)（可选 [Deno](https://deno.com/)），而后就能用更好的体验阅读并运行本书中的代码。
